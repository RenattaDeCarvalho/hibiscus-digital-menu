...
export function MenuHeader({ locale, onLocaleChange, showBack, onBack }: MenuHeaderProps) {
      ...
      <div className="max-w-[800px] mx-auto px-4 py-3 flex items-center justify-between">
        <div className="flex items-center gap-3 min-w-[100px]">
          {showBack ? (
            ...
            <Link href="/admin" className="flex items-center gap-1.5 text-[hsl(40,10%,45%)] hover:text-[hsl(40,60%,55%)] transition-colors text-[11px] tracking-[0.2em] uppercase">
        ...
        {showBack ? (
          <span className="font-serif text-[hsl(40,20%,85%)] text-xl italic tracking-wide">Hibiscus</span>
        ) : (
